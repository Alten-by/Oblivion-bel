...
4. **`ST_HardcodedContent/LOC_HC_MenuGamesettings_sMiscApprenticeSkills`**
   `custom: "Навыки вучня"` — рускае напісанне «Навыки» замест беларускага
   «Навыкі». Прапанова: `"Навыкі вучня"`.

5. **`ST_HardcodedContent/LOC_HC_EffectItemList_sMagicCostliestEffectSkillOf`**
   `en: " Skill of"` мае вядучы прабел (відаць, патрэбны для канкатэнацыі
   з папярэднім словам у гульні); `custom: "Навык"` без вядучага прабелу.
   Варта праверыць у гульні, ці не «зліпаюцца» словы; магчыма патрэбна
   `" Навык"` або `" ад навыку"` — пакінута на меркаванне чалавека.
